...
def markov_decision_process(o, g, h, s, T, f, p):
            ...
            for current_stock in range(s+1):
                ...
                for inbound in range(0, s+1):
                    ...
                    for next_stock in range(s+1):
                        reward += P[current_stock][next_stock] * u[t+1][next_stock]
...
def run_example():
    ...
    markov_decision_process(o, g, h, s, T, f, p)
